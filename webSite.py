...
with col2:
    st.write('Crawling: ', url_input2)

    crawler.createSumSent(url_input2)

    # time.sleep(10)
    # st.text('Fixed width text')
    jsonObject3 = json.load(open('summary.json'))
    col2.json(jsonObject3)
    jsonObject4 = json.load(open('sentiment.json'))
    col2.json(jsonObject4)
# if url_input:
#     st.write('Crawling: ', url_input)
